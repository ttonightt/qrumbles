...
describe("BinaryAsArray", () => {
	...
	describe("static join", () => {
		...
		test("all init but some are their bytes", () => {

			const [ arr1, arr2, arr3, arr4 ] = getInit();

			const arr_ = BinaryAsArray.join( arr1.bytes, arr2, arr3.bytes, arr4 );

			expect( arr_.bitLength ).toBe(67);

			deepEqualIntArrays(
				arr_.bytes,
				[0b10101010, 0b00110101, 0b11001100, 0b01010101, 0b00100000, 0b11110000, 0b01011010, 0b11010101, 0b00100000]
			);
		});
	});
